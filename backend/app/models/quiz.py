...
class Quiz(Base):
    ...
    quiz_type = Column(String(20), nullable=False, server_default="multiple_choice")  # multiple_choice | ox
    question = Column(Text, nullable=False)
    options = Column(JSON, nullable=True)  # 객관식: ["선택지1", ...4개], OX: ["O", "X"]
    answer = Column(String(255), nullable=False)  # options 중 하나
